...
namespace iText.Samples.Htmlsamples.Chapter06
{
    public class C06E04_WebOpenFormatFonts
    {
        ...
        /// </summary>
        public static readonly String DEST = "results/htmlsamples/ch06/fonts_woff.pdf";

        /// <summary>
        /// The path to the source HTML file.
        /// </summary>
        public static readonly String SRC = "../../resources/htmlsamples/html/fonts_woff.html";
