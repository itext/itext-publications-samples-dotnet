...
{
    /// <summary>
    /// Creates a PDF document from an XML file using XSLT to convert the XML to HTML, introducing customized bookmarks.
    /// </summary>
    public class C04E07_MovieInvoice2
    {
        ...
        /// </summary>
        public static readonly String DEST = "results/htmlsamples/ch04/movie_invoice2.pdf";
