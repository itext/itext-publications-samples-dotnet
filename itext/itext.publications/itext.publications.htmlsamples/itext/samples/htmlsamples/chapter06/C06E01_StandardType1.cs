...
namespace iText.Samples.Htmlsamples.Chapter06
{
    public class C06E01_StandardType1
    {
        ...
        /// </summary>
        public static readonly String DEST = "results/htmlsamples/ch06/fonts_standard_type1.pdf";

        /// <summary>
        /// The path to the source HTML file.
        /// </summary>
        public static readonly String SRC = "../../../resources/htmlsamples/html/fonts_standardtype1.html";
