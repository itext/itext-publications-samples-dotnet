...
namespace iText.Highlevel.Notused.Appendix {
    ...
    public class CellProperties {
        ...
        public virtual void CreatePdf(String dest) {
            ...
            table.AddCell(new Cell().SetBorder(new DottedBorder(5)).Add("Test 2").AddStyle(style).SetRelativePosition(
                10, 10, 50, 10));
            ...
            table.AddCell(new Cell().Add(ParagraphProperties.GetNewParagraphInstance()).SetHyphenation(new HyphenationConfig
                ("en", "uk", 3, 3)));
            table.AddCell(new Cell().Add("Rotated").SetRotationAngle(Math.PI / 18).SetFont(font).SetFontSize(8).SetFontColor
                (Color.RED));
            table.AddCell(new Cell().Add("Centered").SetTextAlignment(TextAlignment.CENTER).SetAction(PdfAction.CreateGoTo
                ("Top")));
            ...
            Cell cell = new Cell().Add("Test").SetFixedPosition(100, 400, 350).SetBorder(border).SetBackgroundColor(Color
